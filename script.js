...
class Factory {
  ...
  // customerBuild('red', "heated seats, rear spoiler")
}
...
class Car extends Factory {
  constructor(model, trim, transmission, color, seatstrim, audio, wheelstrim, doors, enginetype, moonroof) {
    super()
    this.model = model;
    this.doors = doors;
    this.color = color;
...
class Sport extends Car {
  constructor(model, trim, transmission, color, seatstrim, audio, wheelstrim, top) {
    super(model, trim, transmission, color, seatstrim, audio, wheelstrim, 2, 'gasoline', false);
    this.top = top;
...
let mazda3 = new Car('mazda3', 'touring', 'automatic', 'red', 'leather', 'premium', 'base', 4, 'hybrid', true)
...
// Write your code below:
let miataRf = new Sport('Miata-RF', 'Grand Touring', 'manual', 'red', 'leather', 'premium', 'premium', 'hard top');
